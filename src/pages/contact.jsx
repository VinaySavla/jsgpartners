        ...
        <div className="row gy-4 justify-content-center">
          ...
          <div className="col-lg-3">
            <div className="info-item d-flex">
              <i className="bi bi-geo-alt flex-shrink-0" style={{ color: '#000', backgroundColor: '#1DA4BA' }}></i>
              <div>
          ...
          <div className="col-lg-3">
            <div className="info-item d-flex">
              <i className="bi bi-envelope flex-shrink-0" style={{ color: '#000', backgroundColor: '#1DA4BA' }}></i>
              <div>
          ...
          <div className="col-lg-3">
            <div className="info-item d-flex">
              <i className="bi bi-phone flex-shrink-0" style={{ color: '#000', backgroundColor: '#1DA4BA' }}></i>
              <div>
          ...
          <div className="col-lg-9">
            <form action="forms/contact.php" method="post" role="form" className="php-email-form">
              ...
              <div style={{ marginBottom:50}} className="text-center">
                <button type="submit" style={{ backgroundColor: '#1DA4BA' }}>Send Message</button>
              </div>
            </form>
          </div>
